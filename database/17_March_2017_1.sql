...
CREATE DATABASE learnhanzi_database WITH OWNER learnhanzi ENCODING 'UTF-8' TABLESPACE learnhanzi_tablespace ALLOW_CONNECTIONS TRUE CONNECTION LIMIT -1 IS_TEMPLATE TRUE;
